...
Usage: {{ include "helm-chart.componentName" (dict "root" . "component" "backend") }}
*/}}
{{- define "helm-chart.componentName" -}}
{{- $root := .root -}}
{{- $component := .component -}}
{{- printf "%s-%s" (include "helm-chart.fullname" $root) $component | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{/*
Component selector labels.
Usage: {{ include "helm-chart.componentSelectorLabels" (dict "root" . "component" "backend") }}
*/}}
{{- define "helm-chart.componentSelectorLabels" -}}
{{ include "helm-chart.selectorLabels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end }}

{{/*
Component common labels.
Usage: {{ include "helm-chart.componentLabels" (dict "root" . "component" "backend") }}
*/}}
{{- define "helm-chart.componentLabels" -}}
{{ include "helm-chart.labels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end }}
